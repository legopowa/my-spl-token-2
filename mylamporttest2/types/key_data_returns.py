...
class keyData_returnsJSON(typing.TypedDict):
    key_type: key_type.KeyTypeJSON
    pkh: list[int]


@dataclass
class keyData_returns:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "keyData_returns":
    ...
    def to_json(self) -> keyData_returnsJSON:
        return {"key_type": self.key_type.to_json(), "pkh": self.pkh}

    @classmethod
    def from_json(cls, obj: keyData_returnsJSON) -> "keyData_returns":
