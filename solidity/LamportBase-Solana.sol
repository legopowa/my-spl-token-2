...
contract LamportBase2 {
    ...
    //     }
    // }
    function performLamportMasterCheck(bytes32 nextPKH, bytes memory prepacked) public returns (bool) {
        require(initialized, "LamportBase: not initialized");
    ...
    //     }
    // }
    function performLamportOracleCheck(bytes32 nextPKH, bytes memory prepacked) public returns (bool) {
        require(initialized, "LamportBase: not initialized");
        AccumulatedData storage data = pendingValidations[msg.sender];
    ...
    modifier onlyLamportOracle(bytes32 nextPKH, bytes memory prepacked) {
        require(initialized, "LamportBase: not initialized");
